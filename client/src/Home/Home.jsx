...
const Home = () => {
  return (
    <div className="font-sans bg-gray-50 text-gray-800">
      ...
      {/* Hero Section */}
      <section className="bg-gray-900 text-center py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold mb-4 text-white">File Sharing, Made Effortless</h2>
      ...
      {/* Features */}
      <section className="bg-gray-800 py-14 px-4">
        <h2 className="text-3xl font-bold text-center mb-12 text-white">Why Choose Share Pod?</h2>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-gray-900 p-6 rounded-lg shadow hover:shadow-md transition">
            ...
            <h3 className="text-xl font-semibold mb-2 text-white">Seamless Uploads</h3>
            <p className="text-gray-300">Upload large files easily and securely.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow hover:shadow-md transition">
            ...
            <p className="text-gray-300">Password-protected links with expiry options.</p>
          </div>
          <div className="bg-gray-900 p-6 rounded-lg shadow hover:shadow-md transition">
            <GoFileSubmodule size={55} className="mx-auto mb-4 text-purple-600" />
            <h3 className="text-xl font-semibold mb-2 text-white">Access Anywhere</h3>
            <p className="text-gray-300">Files available 24/7 across devices.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-900 py-14 px-4">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            ...
            <h3 className="text-xl font-semibold mb-2 text-white">Upload</h3>
            <p className="text-gray-300">Drag and drop your files into the uploader.</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            <FaLink size={55} className="mx-auto mb-4 text-blue-600" />
            <h3 className="text-xl font-semibold mb-2 text-white">Generate Link</h3>
            <p className="text-gray-300">Get a secure link to share instantly.</p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow">
            <FaShareSquare size={55} className="mx-auto mb-4 text-pink-500" />
            <h3 className="text-xl font-semibold mb-2 text-white">Share</h3>
            <p className="text-gray-300">Send the link to your peers or clients.</p>
          </div>
        </div>
      </section>
      ...
      {/* Tools & Technologies */}
      <section className="bg-gray-800 py-14 px-4">
        <h2 className="text-3xl font-bold text-center mb-10 text-white">Built With Modern Tools</h2>
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="bg-gray-900 p-4 rounded-lg shadow flex flex-col items-center">
            ...
            <p className="font-medium text-white">Redux Toolkit</p>
          </div>
          <div className="bg-gray-900 p-4 rounded-lg shadow flex flex-col items-center">
          ...
          <div className="bg-gray-900 p-4 rounded-lg shadow flex flex-col items-center">
            ...
            <p className="font-medium text-white">Node.js (Backend)</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-900 py-12 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <FaLaptopCode size={40} className="mx-auto text-gray-300 mb-4" />
      ...
      <section className="bg-blue-600 text-white text-center py-12 px-4">
        ...
        <Link to="/dashboard">
          <button className="bg-gray-900 text-white px-6 py-3 rounded-full font-medium hover:bg-gray-800 transition shadow">
            Upload Files
          </button>
        </Link>
      </section>
